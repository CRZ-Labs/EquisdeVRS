...
Public Class AudioClient
    ...
    Private Sub Audio_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.WindowState = FormWindowState.Minimized
            IPSERVIDOR = Main.ServerIP
            PUERTO = "21114"
            Try
    ...
    Private Sub AUDIO_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            m_IsFormMain = False
            StopRecordingFromSounddevice_Client()
            DisconnectClient()
