...
Public Class AudioServer
    ...
    Private Sub AudioTCP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            TCPCMDReader.DiagnosticPosting("AudioTCP Iniciado!", "TCP.DGN.AudioTCP", True, False)
            ...
            Next
            PUERTO = "21114"
            TCPCMDReader.DiagnosticPosting("IP: " & PRIVADA & " Port: " & PUERTO, "TCP.DGN.AudioTCP", True, False)
            Try
            ...
            Catch ex As Exception
            End Try
            TCPCMDReader.DiagnosticPosting("AudioTCP iniciado sin complicacion.", "TCP.DGN.AudioTCP", True, False)
        Catch ex As Exception
            Console.WriteLine("[AudioServer@Form1_Load]Error: " & ex.Message)
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub OnServerClientConnected(ByVal st As ServerThread)
        Try
            ...
            data.Init(st, Nothing, SamplesPerSecondServer, BitsPerSampleServer, ChannelsServer, m_SoundBufferCount, _
...
Public Class ServerThreadData
    ...
    Public Sub Init(ByVal st As ServerThread, ByVal soundDeviceName As String, ByVal samplesPerSecond As Integer, ByVal bitsPerSample As Integer, ByVal channels As Integer, ByVal soundBufferCount As Integer, _
